...
(jvm.$ = jQuery),
  ...
  (jvm.Map.prototype = {
    ...
    updateSize: function () {
      (this.width =
        this.container.width() > 790 ? 790 : this.container.width()),
        (this.width =
          this.width > 790 ? 790 : this.width < 400 ? 290 : this.width),
        (this.height = this.container.height() < 400 ? 400 : this.container.height()),
        this.resize(),
